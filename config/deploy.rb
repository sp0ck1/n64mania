...
set :application, "n64mania"
set :repo_url, "git@github.com:sp0ck1/n64mania.git"
...
set :linked_files, %w{config/database.yml config/master.key config/application.yml}
